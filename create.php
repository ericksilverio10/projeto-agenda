    ...
    <div style="text-align: center;" class="container">
        ...
        <div class="form-group">
            <div style= "margin-bottom: 20px;" class="form-nome">
                ...
                <label style="margin-right: 10px; font-size: 20px;" for="felipe"><input style="margin-right: 6px;" class="form_input_radio" required type="radio" name="nome" value="Felipe" id="felipe">Fellype</label>
            </div>
            <div style= "margin-bottom: 20px;" class="form-data">
                <h2 style= "margin-bottom: 10px;">Data de hoje:</h2>
                <input class="form_input_text" type="date" name="data" id="data">
            </div>
